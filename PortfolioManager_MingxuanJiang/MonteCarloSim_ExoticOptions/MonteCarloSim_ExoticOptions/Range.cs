...
namespace MonteCarloSim_ExoticOptions
{
    ...
    {
        public Range(double S, double K, double Rate, double Sigma, double Tenor, int Sims, int Steps, bool TYPE, bool Ant, bool CV, bool Multithreading, double Rebate, double Barrier, int BarrierType)
