...
namespace MonteCarloSim_Multithreading
{
    class Option
    {
        ...
        private int trials, steps; private bool type, ant, cv, multithreading;
        private double[,] rn;
        //S means underlying
        ...
        public Option(double s, double k, double r, double sigma, double T, int trials, int steps, bool type, bool ant, bool cv, bool multithreading)
        {
            S = s;
            K = k;
            Rate = r;
        ...
        public virtual double[] OptionPrice()
        {
